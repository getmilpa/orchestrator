...
/**
 * This file is part of milpa/orchestrator — the event-sourced process engine of the Milpa PHP framework.
 *
...
/**
 * Generates the static API reference site for milpa/orchestrator.
 *
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Orchestrator',
    nsPrefix: 'Milpa\\Orchestrator\\',
    installCommand: 'composer require milpa/orchestrator',
    repoUrl: 'https://github.com/getmilpa/orchestrator',
    pagesUrl: 'https://getmilpa.github.io/orchestrator/',
    heroParagraph: 'Event-sourced <strong>process orchestration</strong> for Milpa: <strong>everything is a process</strong>, '
        . 'a process is a state machine, and <strong>state is a projection of an append-only log</strong>. Human gates carry '
        . 'live decision surfaces whose options map <strong>1:1</strong> to the process\'s own transitions; self-approval is '
        . 'refused by construction; three MCP tools drive it all. The greenhouse (<code>example-agent-ready-blog</code>) '
        . 'proved the loop before this package froze the contracts.',
    utmContent: 'orchestrator',
);
